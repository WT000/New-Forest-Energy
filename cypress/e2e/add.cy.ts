describe("Add home Test", () => {
    ...
    it("validation for adding a home ", () => {
      ...
      cy.getByData("errormessage").should("have.text", "Home Name *Must be at least 4 characters.Homeowner *Must be a signed-up user.Total Beds *Must be at least 1 and whole.Cost Buffer (per day) *Must be at least £0.Energy Tariff (per Kwh) *Must be at least £0.01.Delegate Emails (comma separated) ");
