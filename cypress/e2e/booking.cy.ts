describe("Home Page Test", () => {
  ...
  it("Date failure check", () => {
    ...
    cy.get(".text-black-500.text-xs").should(
      "have.text",
      "Home Guest Surname Start Date *Must be beyond now and not conflict.End Date *Must be beyond start and not conflict."
    );
  });
  ...
  it("Empty fields validation", () => {
    ...
    cy.get(".text-black-500.text-xs").should(
      "have.text",
      "Home Guest Surname *RequiredStart Date *Must be beyond now and not conflict.End Date *Must be beyond start and not conflict."
    );
  });
